"""Advanced RAG core components for Buổi 08.

This module contains lexical retrieval, semantic retrieval, fusion, reranking,
answer generation, and status helpers. The heavy model dependencies are loaded
lazily to keep import-time lightweight for tests and status checks.
"""
...
def _build_collection_name(strategy: str, model: str, dim: int) -> str:
    ...
    return f"buoi_08_{normalized_strategy}_{normalized_model}_{dim}"
